<template>
  <div class="container">
    <v-app-bar color="deep-purple" dark>
      ...
      <v-btn class="searchBtn" height="100" text @click="handleSearch">
        <v-icon>mdi-magnify</v-icon>
        Search
      </v-btn>
      <v-btn class="searchBtn" height="100" text @click="handleSearch">
        <v-icon @click="createDilog=true">mdi-plus</v-icon>
        <div v-if="createDilog">
          <AddDepartmentItem :createDilog="createDilog" :initPage="initPage" />
        </div>
        Create
      </v-btn>
    </v-app-bar>
    <!-- departnments card container -->
